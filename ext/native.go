...
// FieldNameHandler is a handler for mapping a reflect.StructField to a CEL field name.
// This can be used to override the default field name mapping.
type FieldNameHandler = func(field reflect.StructField) string
...
// TODO: Since there hasn't been a tagged version since this was added, we could remove this and just support ParseStructField below
// TODO: instead. This would work better if fieldNameByTag above was exported.
...
func ParseStructField(handler FieldNameHandler) NativeTypesOption {
	return func(ntp *nativeTypeOptions) error {
...
func toFieldName(fieldNameHandler FieldNameHandler, f reflect.StructField) string {
...
func newNativeTypes(fieldNameHandler FieldNameHandler, rawType reflect.Type) ([]*nativeType, error) {
...
func newNativeType(fieldNameHandler FieldNameHandler, rawType reflect.Type) (*nativeType, error) {
	refType := rawType
